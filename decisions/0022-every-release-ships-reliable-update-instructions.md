...
- Amended by: [ADR-0026](0026-pin-canonical-artifact-header-format.md), [ADR-0031](0031-adopter-update-is-human-intent-agent-execution.md), [ADR-0041](0041-harden-the-copy-driven-recopy-against-missed-scaffolds.md), [ADR-0042](0042-reframe-update-step-2-as-enumerate-and-copy.md)
